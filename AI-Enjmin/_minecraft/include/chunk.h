	...
	public :
		...
		private:
			...
			void addToPhysic()
			{
				...
				if(_NbVertices > 0)
				{
					btGImpactMeshShape * mesh = NYBasicPhysicEngine::getInstance()->calcTriMeshShape(_WorldVert,_NbVertices,3*sizeof(float)); 
					_Body = NYBasicPhysicEngine::getInstance()->addTriMeshObject(false,mesh,
												 NYVert3Df(_XPos*NYChunk::CHUNK_SIZE*NYCube::CUBE_SIZE,
															_YPos*NYChunk::CHUNK_SIZE*NYCube::CUBE_SIZE,
															_ZPos*NYChunk::CHUNK_SIZE*NYCube::CUBE_SIZE),0.0f);
